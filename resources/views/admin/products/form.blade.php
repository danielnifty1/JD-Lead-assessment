...
@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <span id="error-message" class="mb-4 text-red-500 w-full place-items-center aligh-center items-center justify-center">
                <p id="error-message-text"></p> 
            <form id="formData" action="{{ isset($product) ? route('admin.products.update', $product) : route('admin.products.store') }}"
